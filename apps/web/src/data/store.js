export const CATEGORIAS_GASTO = [
  { id: 'vivienda', label: 'Vivienda', icon: 'Home', color: '#01696f' },
  { id: 'servicios', label: 'Servicios', icon: 'Bolt', color: '#0f766e' },
  { id: 'alimentacion', label: 'Alimentación', icon: 'ShoppingCart', color: '#437a22' },
  { id: 'transporte', label: 'Transporte', icon: 'Car', color: '#006494' },
  { id: 'salud', label: 'Salud', icon: 'Heart', color: '#964219' },
  { id: 'deporte', label: 'Deporte', icon: 'Dumbbell', color: '#1d4ed8' },
  { id: 'ocio', label: 'Ocio', icon: 'Gamepad2', color: '#d19900' },
  { id: 'compras', label: 'Compras', icon: 'Package', color: '#7a39bb' },
  { id: 'educacion', label: 'Educación', icon: 'GraduationCap', color: '#a13544' },
  { id: 'ropa', label: 'Ropa', icon: 'Shirt', color: '#da7101' },
  { id: 'viajes', label: 'Viajes', icon: 'Plane', color: '#0891b2' },
  { id: 'regalos', label: 'Regalos', icon: 'Gift', color: '#be185d' },
  { id: 'otros', label: 'Otros', icon: 'MoreHorizontal', color: '#7a7974' },
]

export const CATEGORIAS_INGRESO = [
  { id: 'nomina', label: 'Nómina', icon: 'Briefcase', color: '#01696f' },
  { id: 'freelance', label: 'Freelance', icon: 'Code2', color: '#437a22' },
  { id: 'inversiones', label: 'Inversiones', icon: 'TrendingUp', color: '#006494' },
  { id: 'otros_ingreso', label: 'Otros', icon: 'Plus', color: '#7a7974' },
]

export const CATEGORIAS_AHORRO = [
  { id: 'ahorro', label: 'Ahorro', icon: 'PiggyBank', color: '#01696f' },
]

export const CATEGORIAS_TRANSFERENCIA = [
  { id: 'transferencia_interna', label: 'Transferencia Interna', icon: 'ArrowLeftRight', color: '#0f766e' },
]

export const CATEGORIAS_AJUSTE = [
  { id: 'ajuste_manual', label: 'Ajuste manual', icon: 'Scale', color: '#7a7974' },
]

export const CATEGORIAS_EDITABLES_INICIALES = [
  ...CATEGORIAS_GASTO,
  ...CATEGORIAS_INGRESO,
  ...CATEGORIAS_AHORRO,
...
function varPct(seed, amplitude = 0.08) {
...
function generarTransacciones() {
    ...
    recurrentes.forEach((mov, recIndex) => {
      ...
      if (fecha <= TODAY) {
        ...
        out.push({
          ...
          tipo: mov.tipo,
          cuentaId: 1,
          cuentaDestinoId: mov.tipo === 'ahorro' || mov.tipo === 'transferencia' ? 2 : null,
        })
      }
    })
  ...
  return out.sort((a, b) => new Date(b.fecha) - new Date(a.fecha) || b.id - a.id)
}

export const transaccionesIniciales = generarTransacciones()

function computeMonthlySeries(transacciones) {
...
export const patrimonioMensual = computeMonthlySeries(transaccionesIniciales)

export const cuentasIniciales = [
  { id: 1, nombre: 'Cuenta personal Miguel', tipo: 'personal', saldo: 0, icono: 'Building2', color: '#006494' },
  { id: 2, nombre: 'Cuenta personal Sara', tipo: 'personal', saldo: 0, icono: 'Building2', color: '#7a39bb' },
  { id: 3, nombre: 'Cuenta compartida', tipo: 'compartida', saldo: 0, icono: 'Wallet', color: '#01696f' },
]
